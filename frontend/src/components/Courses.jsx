...
const Courses = () => {
    ...
    return (
        <div className="flex">
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-0 left-0 h-screen bg-gray-300 w-64 p-5 transform z-10 transition-transform duration-300 ease-in-out ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
